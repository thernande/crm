  ...
  <div id="content">
    ...
    <div id="my-tab-content" class="tab-content">
        ...
        <div class="form-group">
          ...
          <?php echo $Proffer['Customer']['phone'] ?>
        </div>

        <div class="form-group">
          <label for="" class="control-label">Dirección : </label>
          <?php echo $Proffer['Customer']['dress'] ?>
        </div> 

        <div class="form-group">
          <label for="" class="control-label">Municipio : </label>
          <?php echo $Municipalities[$Proffer['Customer']['municipality_id']] ?>
        </div> 

        <div class="form-group">
          <label for="" class="control-label">Email : </label>
          <?php echo $Proffer['Customer']['email'] ?>
        </div> 

        <div class="form-group">
          <label for="" class="control-label">Estado : </label>
          <?php echo $Proffer['Customer']['state'] ?>
        </div> 

        <div class="form-group">
          <label for="" class="control-label">Funcionario responsable : </label>
          <?php echo $Proffer['User']['name'] ?>
        </div> 
        ...
        <div class="tab-pane " id="note">
            ...
            <h2><span class="label label-warning">Notas</span></h2>
                <div class="form-group">
                  <div class ="success">
                  <?php echo $Proffer['Customer']['note'] ?>
                  </div>
                </div> 

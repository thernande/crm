...
<ol class="breadcrumb">
  <li><?php echo $this->Html->link("Home", array('controller' => 'admin',  'action' => 'index')); ?></li>
   <li><?php echo $this->Html->link("Propuestas de Negocio", array('controller' => 'Oportunitys',  'action' => 'index')); ?></li>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
	...
	<!-- formulario para la subir los archivos(oculto hasta que se oprime el boton subir archivo) -->
      ...
      <?php echo $this->Form->input("customer", array( 'type' => 'hidden', 'value' =>  $Oportunity['Customer']['name'] )); ?> 
      <?php echo $this->Form->input("customer_id", array( 'type' => 'hidden', 'value' =>  $Oportunity['Customer']['id'] )); ?> 
      ...
      <?php echo $this->Form->input('Oportunity_id', array('type'=>'hidden', 'value' => $Oportunity['Oportunity']['id'])); ?>		
  ...
  <div id="content">
    <div id="my-tab-content" class="tab-content">
        <div class="tab-pane active" id="data">      
           ...
           <?php echo $Oportunity['Customer']['name'] ?>
          </div>
        ...
        <div class="form-group">
          ...
          <?php echo $Oportunity['Oportunity']['description'] ?>
        </div> 

        <div class="form-group">
          <label for="" class="control-label">fecha de creacion : </label>
          <?php echo $Oportunity['Oportunity']['created'] ?>
        </div> 

        <div class="form-group">
          <label for="" class="control-label">fecha de expiracion : </label>
          <?php echo $Oportunity['Oportunity']['expired'] ?>
        </div> 
		</div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function ($) {
        $("#list").jqGrid({
        	url:'<?php echo $this->Html->url(array("controller" => "files", "action" => "showGridFile", $Oportunity["Oportunity"]["id"])); ?>',
        	datatype:"json",
        	mtype:"POST",
